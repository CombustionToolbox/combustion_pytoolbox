...
from utils.databases.set_elements import *
from utils.databases.ParseThermoInp import ParseThermoInp
from utils.databases.GenerateDatabase import GenerateDatabase
...
def Initialize(LS='HC/02/N2 EXTENDED'):
    app = App()
    app.S.NameSpecies = tuple(app.DB.keys())
...
class App:
    def __init__(self):
        ...
        self.DB_master = ParseThermoInp(False)
        # struct with tabulated data of selected species
        self.DB = GenerateDatabase(self)
