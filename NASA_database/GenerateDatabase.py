...
def GenerateDatabase(self): # self is a dictionary with Master Database
    filepath = 'Databases/strThProp.pkl'
            ...
            if species in self.strMaster:
                ...
                if ctTInt > 0:
                    ...
                    for T in np.concatenate((np.linspace(Tmin, 298.15, 4),  np.linspace(350., Tmax, 60))):
                        [_ , _, Cp0, Cv0, Hf0, H0, Ef0, E0, S0, DfG0] = SpeciesThermProp(self, FullSpecies, T, 'molar', 0)
